...
from deeppde_rl.protocol import DataProtoFuture
...
def _split_args_kwargs_data_proto(chunks, *args, **kwargs):
    from deeppde_rl.protocol import DataProto, DataProtoFuture
    splitted_args = []
    for arg in args:
...
def dispatch_dp_compute(worker_group, *args, **kwargs):
    from deeppde_rl.single_controller.base.worker_group import WorkerGroup
...
def collect_dp_compute_data_proto(worker_group, output):
    from deeppde_rl.protocol import DataProto
    import ray
